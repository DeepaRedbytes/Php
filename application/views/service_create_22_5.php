...
if(!empty($serviceDetail)) { 
    ...
    if(!empty($serviceDetail['price_on'])) { $price_on = $serviceDetail['price_on']; } 
                ...
                <div class="col-md-12 bottom-border">
                    <div class="col-md-4 no-padding display-center">
                     ...
                     <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-8 full-input-txtarea mr-3">
                                <textarea type="text" placeholder="terms & condition" rows="6" id="address" name="terms_and_condition"><?=$terms_and_condition;?></textarea> 
                              </div>
                        </div>    
                    </div>
              </div>  
                 ...
                 <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-5 full-input mr-3">
                          ...
                          <input type="text" id="priceId" maxlength="6" name="price" placeholder="500" value="<?php if($price != 0){ echo $price;}?>" 
                             onkeypress='return event.charCode >= 48 && event.charCode <= 57' >
                        </div>

                        <div class="col-md-2 display-center ">
                      ...
                      <div class="row">
                        <div class="col-md-3 display-center ">
                            <label class="pure-material-radio">
                                <input class="radioButton" type="radio" id="pType" name="price_type" <?php if($price_type == "hrs"){echo "checked";}?> value="hrs" >
                                <span>Per Hrs</span>
                            </label>                             
                        </div> 
                        <div class="col-md-3 display-center">
                            <label class="pure-material-radio">
                                <input class="radioButton" type="radio" id="pType" name="price_type" <?php if($price_type == "day"){echo "checked";}?>  value="day">
                                <span>Per Day</span>
                            </label>
                        </div>
                   </div>  
          ...
          <div class="col-md-12 bottom-border">
           ...
           <div class="clearfix">
               <div class="button-align">
                ...
                <input type="text" name="latitude" id="latitude" value="<?=$latitude;?>" style="display: none;"><!--  c -->
                  <input type="text" name="longitude" id="longitude" value="<?=$longitude;?>" style="display: none;">
                  <button type="submit" id="submitButton" class="signupbtn custome-button"><span class="normal-class">Submit</span><span class="normal-icon"><i class="fas fa-check"></i></span></button>
               </div>
          </div>
       </div>
        <?php echo form_close(); ?>  
