                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8 check-box">
                      <div class="row">
                        <div class="col-md-12">
                          <div class="row">                      
                            <div class="col-md-3 display-center"><input <?php if($status == '1') { echo 'checked'; } ?> type="radio" name="status" value="1"> Active</div>  
                            <div class="col-md-3 display-center"><input <?php if($status == '0') { echo 'checked'; } ?> type="radio" name="status" value="0"> Inactive</div>
                          </div>
                        </div>
                      </div>
                    </div>
