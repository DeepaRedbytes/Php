...
if(!empty($eventDetail)) { 
    ...
    if(!empty($eventDetail['latitude'])) { $latitude = $eventDetail['latitude']; }
    if(!empty($eventDetail['longitude'])) { $longitude = $eventDetail['longitude']; }
    ...
    if(!empty($eventDetail['price_on'])) { $price_on = $eventDetail['price_on']; } 
    ...
    if(!empty($eventDetail['email'])) { $email = $eventDetail['email']; }
    if(!empty($eventDetail['phone'])) { $phone = $eventDetail['phone']; }
    if(!empty($eventDetail['eventUrl'])) { $eventUrl = $eventDetail['eventUrl']; }
      ...
      <?php echo form_open('event/create', ['id' => 'createEventForm','enctype'=>"multipart/form-data"]); ?>
        <div class="no-padding">
            ...
            <div class="col-md-12">
                 ...
                 <div class="col-md-3 full-input mr-3">
                     ...
                     <select required name="category">
                       <option disabled selected value="">Select</option>
                        <?php foreach($category_array as $categorys){ ?>
                       <option value="<?=$categorys['id'];?>" <?php echo ($categorys['id'] == $category)?'selected':''?> ><?=$categorys['category'];?></option>
                      <?php  }?>                                          
                     </select>
                     <i class="mandfeild">*</i>
                   ...
                   <div class="col-md-2 full-input mr-3">
                      ...
                      <select id="duration" name="duration">
                        ...
                        <option value="" <?php if($duration == '') { echo 'selected'; } ?> >Select</option>

                        <?php for($i=1; $i<11; $i++) { $j=$i.' hrs'; ?>
                          <option value="<?php echo $j;?>" <?php if($duration == $j) { echo 'selected'; } ?>><?php echo $j;?></option><?php 
                        } ?>
                        <option value="Fullday" <?php if($duration == 'Fullday') { echo 'selected'; } ?>>Fullday</option>
                   ...
                   <div class="col-md-2 full-input mr-3">
                      ...
                      <select id="age" name="age">
                        <option value="" <?php if($age == '') { echo 'selected'; } ?> >Select</option>
                        ...
                        <option value="Everyone" <?php if($age == 'Everyone') { echo 'selected'; } ?> >Everyone</option>
                      </select>
                  </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-3 full-input mr-3">
                    ...
                    <input type='text' id="priceId" maxlength="6" name='price' onkeypress='return event.charCode >= 48 && event.charCode <= 57' placeholder='500' value="<?php if($price != 0){ echo $price;}?>">                     
                </div>
                ...
                <div class="col-md-4 full-input mr-3" style="display: none;">
          ...
          <div class="col-md-12 bottom-border">
              ...
              <div class="col-md-12">
                <div class="row">
                  ...
                  <div class="col-md-2 full-input mr-3">
                      ...
                      <input id="start" name="start_time" class="validate ui-timepicker-input" placeholder="00:00" value="<?=$start_time?>"/>
                  </div>
                  <div class="col-md-3 full-input mr-3">
                  ...
                  <div class="col-md-2 full-input mr-3">
                      ...
                      <input id="end" name="end_time" class="validate ui-timepicker-input" placeholder="00:00" value="<?=$end_time?>"/>
                  </div>
                </div>   
              </div>
            </div>  
            ...
            <?php /*?><div class="col-md-12 bottom-border" style="display: none;">
              ...
              <div class="col-md-12">
                <div class="row">
                  ...
                  <div class="col-md-4 full-input mr-3">
                    ...
                    <input type='text' name='phone' minlength="6" maxlength="14" value="<?=$phone;?>" required onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                    <i class="mandfeild">*</i>
                   </div>                
                </div>   
              </div>
            ...
            <div class="clearfix">
               <div class="button-align">
                  <button type="submit" class="signupbtn custome-button" id="submitButton"><span class="normal-class">Submit</span><span class="normal-icon"><i class="fas fa-check"></i></span></button>
