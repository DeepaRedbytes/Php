                 ...
                 <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-5 full-input mr-3">
                            ...
                            <input type="text" name="price" placeholder="500" value="<?php if($price != 0){ echo $price;}?>" 
                   ...
                   <div class="row">
                        <div class="col-md-3 display-center ">
                            <label class="pure-material-radio">
                                <input type="radio" name="price_type" <?php if($price_type == "per_hrs"){echo "checked";}?> value="per_hrs" >
                                <span>Per Hrs</span>
                            </label>
                        ...
                        <div class="col-md-3 display-center">
                            <label class="pure-material-radio">
                                <input type="radio" name="price_type" <?php if($price_type == "per_day"){echo "checked";}?>  value="per_day">
                                <span>Per Day</span>
                            </label>
                        </div>
                   </div>  
