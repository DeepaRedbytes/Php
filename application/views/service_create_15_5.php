                            ...
                            <div class="row">
                             ...
                             <div class="row">
                              ...
                              <div class="col-md-4 full-input mr-3">
                                  ...
                                  <!-- <input id="end" placeholder="00:00"/> -->
                              </div>
                             </div> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 display-center ">
                          <label class="pure-material-radio">
                              <input type="radio" id="pon" name="price_on" <?php if($price_on == "aud"){echo "checked";}?> value="aud" >
                              <span>AUD</span>
                          </label>
                        </div> 
                        <div class="col-md-2 display-center">
                            <label class="pure-material-radio">
                                <input type="radio" id="pon" name="price_on" <?php if($price_on == "usd"){echo "checked";}?> value="usd" >
                                <span>USD</span>
                            </label>
                        </div>
                      </div>                    
...
// $(document).ready(function() {
//     var start = $('#timepicker').timepicker({});
//     //init end timepicker
//     var end = $('#timepicker1').timepicker({});
...
//     // //init end timepicker
//     // var end = $("#timepicker1").timepicker().data("timepicker");
