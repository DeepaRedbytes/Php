                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 display-center ">
                          <label class="pure-material-radio">
                              <input type="radio" id="pon" name="price_on" <?php if($price_type == "aud"){echo "checked";}?> value="aud" >
                              <span>AUD</span>
                          </label>
                        </div> 
                        <div class="col-md-2 display-center">
                            <label class="pure-material-radio">
                                <input type="radio" id="pon" name="price_on" <?php if($price_type == "usd"){echo "checked";}?> value="usd" >
                                <span>USD</span>
                            </label>
                        </div>
                      </div>                    
