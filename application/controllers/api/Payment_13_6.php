...
public function index_post(){
      ...
      if($check_auth_client == true){  
        ...
        $orderParams =  ['PAYMENTREQUEST_0_AMT' => '5',
                   // 'PAYMENTREQUEST_0_SHIPPINGAMT' => '0',
                   'PAYMENTREQUEST_0_CURRENCYCODE' => 'USD',
                   'PAYMENTREQUEST_0_ITEMAMT' => '5'
                  ];

        $item     =   [ //'L_PAYMENTREQUEST_0_NAME0' => $product_name,
                 // 'L_PAYMENTREQUEST_0_DESC0' => 'ItemDesc',
               'L_PAYMENTREQUEST_0_AMT0' => '5',
               // 'L_PAYMENTREQUEST_0_QTY0' => $data['selectedQty']
              ];

        $obj    =   new Paypal_lib();
        $result   =   $obj->request('SetExpressCheckout',$requestParams + $orderParams + $item);
        ...
        exit();
            ...
            /*  $gateway = new PaypalGateway();
              // $gateway->apiUsername = "deeparedbytes3-facilitator_api1.gmail.com";
              // $gateway->apiPassword = "Y2VTNDS5QMNY5WJ4";
              // $gateway->apiSignature = "AnV0x-9ayLC.wrAybDNjcw8UazLLADahiAf1KLFFOuwoBR1i0vcpWT28";
